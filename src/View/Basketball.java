...
public class Basketball implements GameViewUI {
	...
	public Basketball(Stage thirdStage, Registry theReg, Championship champ) {
		Text basketBallGame = new Text("BasketBall Game");
		basketBallGame.setFont(new Font(22));
		...
		HBox points1 = new HBox(pointsListFirstParticipants.get(0), pointsListFirstParticipants.get(1),
				pointsListFirstParticipants.get(2), pointsListFirstParticipants.get(3));
		...
		HBox points2 = new HBox(pointsListSecondParticipants.get(0), pointsListSecondParticipants.get(1),
				pointsListSecondParticipants.get(2), pointsListSecondParticipants.get(3));
		...
		vbTitle = new VBox();
		vbTitle.getChildren().add(basketBallGame);
